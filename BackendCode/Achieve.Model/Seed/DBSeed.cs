    ...
    public class DBSeed
    {
        ...
        public static async Task SeedAsync(MyContext myContext)
        {
            try
            {
                ...
                #region Users
                if (!await myContext.Db.Queryable<Users>().AnyAsync())
                {
                    myContext.GetEntityDB<Users>().Insert(new Users()
                    {
                        userid = 32999,
                        Name = "Linn",
                        Account = "G2999",
                    ...
                    Console.WriteLine("Table:Users created success!");
                }
                else
                {
                    Console.WriteLine("Table:SysAdmin already exists...");
